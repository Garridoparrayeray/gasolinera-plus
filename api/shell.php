            ...
            <div class="home-link-wrap">
                <span id="app-logomark" aria-hidden="true">
                    <svg class="logo-gasolinera" viewBox="0 0 24 24" fill="none">
                        <path d="M13 2.5C9.3 5 5.8 9.2 5.8 13.6A6.4 6.4 0 0 0 18.2 13.6C18.2 9.4 15.3 5.7 13 2.5Z" fill="#FFDB00"/>
                        <path d="M12 10V18" stroke="#7A5A05" stroke-width="1.3" stroke-linecap="round"/>
                    </svg>
                </span>
                <span>
